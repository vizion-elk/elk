...
1) Get the [Zip](https://github.com/vizion-elk/Windows-Monitoring/archive/7.7.0.zip) package on the server.
   ...
   ```css
   Start-BitsTransfer -Source "https://github.com/vizion-elk/Windows-Monitoring/archive/7.7.0.zip" -Destination "${env:USERPROFILE}\Downloads\windows-monitoring-7.7.0.zip"
   ```
